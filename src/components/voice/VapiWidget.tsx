    ...
    <div className="max-w-5xl mx-auto px-4 flex flex-col overflow-hidden pb-20">
      ...
      {messages.length > 0 && (
        <div
          ...
          className="w-full hide-scrollbar bg-card/90 backdrop-blur-sm border border-border rounded-xl p-4 mb-8 h-64 overflow-y-auto transition-all duration-300 scroll-smooth"
        >
